<script lang="ts">
    ...
    function submitTestCase() {
        ...
        const validInputs = $inputParameters.every(validateInput) && $outputParameters.every(validateInput);
...
{#if $showAlert}
    <Alert.Root variant="destructive">
        ...
        <Alert.Description>
            Invalid input: Please ensure all types are valid, each parameter has a type, and at
